...
<script>
	...
	// 引入富文本解析组件
	import htmlParse from "@/subpages/components/html-parse/parse.vue";
	// 引入毛玻璃组件
	import picBlur from "@/subpages/components/pic-blur/pic-blur.vue";
	// 引入 评论插件
	...
	export default {
		...
		async onLoad(options) {
			...
			// #endif
			let res = await this.$api.newInfo(options.name);
			res = res.data
...
<style lang="scss" scoped>
	/* 引入富文本解析器 */
	@import '@/subpages/components/html-parse/parse.css';
